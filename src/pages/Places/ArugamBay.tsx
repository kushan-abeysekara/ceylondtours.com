...
const ArugamBay = () => {
  ...
  return (
    <div className="destination-page">
      <SearchBar contentRef={contentRef} placeholder="Search Arugam Bay information..." />
      ...
      <section className="dest-content">
        <div className="dest-container">
          <div className="dest-main-section">
            ...
            <div className="dest-right">
              ...
              <p className="dest-description">
                A world-famous beach destination known for surfing, golden sandy shores, and a relaxed coastal atmosphere on Sri Lanka's east coast.
              </p>
          ...
          <DestinationSuggestions 
            currentDestination="ArugamBay"
            suggestions={getRandomSuggestions('/places/arugam-bay', 4)}
          />
